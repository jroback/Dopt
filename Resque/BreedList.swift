...
//  Resque
//
//  Created by Roback, Jerry on 12/13/17.
//  Copyright © 2017 Roback, Jerry. All rights reserved.
//

import Foundation

public struct SearchBreeds {
    var sectionName: String!
    var sectionBreeds: [String]!
}
...
//EXAMPLE ARRAY QUERY -- Put this inside ViewDidLoad of the mainViewController

//if dogBreedList.contains("Husky") {
//    let breedCheck = dogBreedList.index(of: "Husky")

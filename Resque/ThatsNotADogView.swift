//
//  ThatsNotADogView.swift
//  Resque
//
//  Created by Roback, Jerry on 2/26/18.
//  Copyright © 2018 Roback, Jerry. All rights reserved.
//

import UIKit

class ThatsNotADogView: UIView {

    //VARS
    @IBOutlet weak var resultImageView: UIImageView!
    @IBOutlet weak var cardCopy: UILabel!
    ...
    func loadViewFromNib() -> UIView {
        ...
        let nib = UINib(nibName: "ThatsNotADogView", bundle: bundle)
